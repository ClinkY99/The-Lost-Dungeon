...
def play():
    while True:
        ...
        PLAYtext = get_font(45).render("This is the PLAY screen.", True, "White")
...
def options():
    while True:
        ...
        OPTIONtext = get_font(45).render("This is the OPTIONS screen.", True, "Black")
...
def level_menu():
    while True:
        ...
        screen.fill("yellow")
        leveltext = get_font(45).render("This is the LEVEL screen.", True, "Black")
